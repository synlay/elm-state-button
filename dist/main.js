...
var _synlay$elm_state_button$Animated$shake = function () {
	var start = _mdgriffith$elm_style_animation$Animation$style(
		{
			ctor: '::',
			_0: A2(
	...
	var speed2 = _mdgriffith$elm_style_animation$Animation$speed(
		{perSecond: 150.0});
	var speed1 = _mdgriffith$elm_style_animation$Animation$speed(
		{perSecond: 100.0});
	var animation = {
		ctor: '::',
		_0: A2(
	...
	return {start: start, animation: animation};
}();
var _synlay$elm_state_button$Animated$pulse = function () {
	var start = _mdgriffith$elm_style_animation$Animation$style(
		{
			ctor: '::',
	...
	var speed = _mdgriffith$elm_style_animation$Animation$speed(
		{perSecond: 0.5});
	var animation = {
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _mdgriffith$elm_style_animation$Animation$scale(1.1),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
...
var _synlay$elm_state_button$Animated$rotate = function () {
	var start = _mdgriffith$elm_style_animation$Animation$style(
		{
			ctor: '::',
			_0: A3(
	...
	var animation = {
		...
		_0: A2(
			...
			speed,
			{
				...
				_0: A3(
					_mdgriffith$elm_style_animation$Animation$rotate3d,
					_mdgriffith$elm_style_animation$Animation$turn(0.25),
					_mdgriffith$elm_style_animation$Animation$turn(0),
					_mdgriffith$elm_style_animation$Animation$turn(0)),
				_1: {ctor: '[]'}
			}),
...
var _synlay$elm_state_button$Animated$Animated = F2(
	function (a, b) {
		return {start: a, animation: b};
	});

var _synlay$elm_state_button$Machine$newTransition = F2(
	function (source, target) {
		return {
			...
			_0: A2(
				_elm_lang$core$Basics_ops['++'],
				source.identity,
				A2(_elm_lang$core$Basics_ops['++'], ':', target.identity)),
			_1: {ctor: '_Tuple2', _0: source, _1: target}
		};
	});
var _synlay$elm_state_button$Machine$newState = function (state) {
	return state;
};
var _synlay$elm_state_button$Machine$newMachine = F2(
...
var _synlay$elm_state_button$Machine$Model = F2(
	function (a, b) {
		return {state: a, transitions: b};
	});
var _synlay$elm_state_button$Machine$TransitionError = {ctor: 'TransitionError'};
var _synlay$elm_state_button$Machine$changeState = F2(
	function (key, model) {
		var identity = A2(
			_elm_lang$core$Basics_ops['++'],
			model.state.identity,
			A2(_elm_lang$core$Basics_ops['++'], ':', key));
		var _p0 = A2(_elm_lang$core$Dict$get, identity, model.transitions);
		if (_p0.ctor === 'Just') {
			return _elm_lang$core$Result$Ok(
				_elm_lang$core$Native_Utils.update(
					model,
					{
						state: _elm_lang$core$Tuple$second(_p0._0)
					}));
		} else {
			return _elm_lang$core$Result$Err(_synlay$elm_state_button$Machine$TransitionError);
		}
	});

var _synlay$elm_state_button$Main$viewGetButtonAnimation = function (model) {
	var _p0 = model.state.initAnimation;
	if (_p0.ctor === 'Just') {
		return _mdgriffith$elm_style_animation$Animation$render(_p0._0.start);
	} else {
		return {ctor: '[]'};
	}
};
var _synlay$elm_state_button$Main$viewConstructButtonAnimation = F2(
	function (model, attributes) {
		var animation = _synlay$elm_state_button$Main$viewGetButtonAnimation(model);
		return _elm_lang$core$List$concat(
			{
				ctor: '::',
				_0: animation,
...
var _synlay$elm_state_button$Main$state = _elm_lang$core$Native_Platform.incomingPort('state', _elm_lang$core$Json_Decode$string);
var _synlay$elm_state_button$Main$change = _elm_lang$core$Native_Platform.outgoingPort(
	'change',
	function (v) {
		return v;
	});
var _synlay$elm_state_button$Main$error = _elm_lang$core$Native_Platform.outgoingPort(
	'error',
	function (v) {
		return {message: v.message, error: v.error, state: v.state};
	});
var _synlay$elm_state_button$Main$MachineError = F3(
	function (a, b, c) {
...
var _synlay$elm_state_button$Main$Flags = F4(
	function (a, b, c, d) {
		return {start: a, process: b, succeed: c, failure: d};
	});
var _synlay$elm_state_button$Main$InitAnimation = function (a) {
	return {ctor: 'InitAnimation', _0: a};
};
var _synlay$elm_state_button$Main$view = function (model) {
	var buttonAttributes = A2(
		_synlay$elm_state_button$Main$viewConstructButtonAnimation,
		model,
		{
			ctor: '::',
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class(model.state.icon),
							_1: {
								ctor: '::',
					...
					_1: {
						...
						_0: _elm_lang$html$Html$text(
							A2(_elm_lang$core$Basics_ops['++'], ' ', model.state.text)),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
...
var _synlay$elm_state_button$Main$update = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'InitAnimation':
				var _p4 = _p1._0;
				var _p2 = _p4.state.initAnimation;
				if (_p2.ctor === 'Just') {
					var _p3 = _p2._0;
					var newInitAnimationStart = A2(_mdgriffith$elm_style_animation$Animation$interrupt, _p3.animation, _p3.start);
					var newInitAnimation = _elm_lang$core$Native_Utils.update(
						_p3,
						{start: newInitAnimationStart});
					var state = _p4.state;
					var newAgent = _elm_lang$core$Native_Utils.update(
						state,
						{
							initAnimation: _elm_lang$core$Maybe$Just(newInitAnimation)
						});
					return {
						ctor: '_Tuple2',
			...
			case 'FromJs':
				var _p7 = _p1._0;
				var _p5 = A2(_synlay$elm_state_button$Machine$changeState, _p7, model);
				if (_p5.ctor === 'Ok') {
					var _p6 = _p5._0;
					var animation = A2(
						_synlay$elm_state_button$Main$update,
						_synlay$elm_state_button$Main$InitAnimation(_p6),
						model);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Tuple$first(animation),
						_1: _synlay$elm_state_button$Main$change(_p6.state.identity)
					};
				} else {
					var machineError = {
						message: _elm_lang$core$Basics$toString(_p5._0),
						state: model.state.identity,
						error: _p7
					};
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _synlay$elm_state_button$Main$error(machineError)
					};
				}
			default:
				var _p8 = model.state.initAnimation;
				if (_p8.ctor === 'Just') {
					var _p9 = _p8._0;
					var newInitAnimation = _elm_lang$core$Native_Utils.update(
						_p9,
						{
							start: A2(_mdgriffith$elm_style_animation$Animation$update, _p1._0, _p9.start)
						});
...
var _synlay$elm_state_button$Main$init = function (flags) {
	var failure = _synlay$elm_state_button$Machine$newState(
		{
			identity: 'failure',
	...
	var succeed = _synlay$elm_state_button$Machine$newState(
		{
			identity: 'succeed',
	...
	var machine = A2(
		...
		{
			ctor: '::',
			_0: A2(_synlay$elm_state_button$Machine$newTransition, start, process),
			_1: {
				ctor: '::',
				_0: A2(_synlay$elm_state_button$Machine$newTransition, process, succeed),
				_1: {
					ctor: '::',
					_0: A2(_synlay$elm_state_button$Machine$newTransition, process, failure),
					_1: {
						ctor: '::',
						_0: A2(_synlay$elm_state_button$Machine$newTransition, succeed, start),
						_1: {
							ctor: '::',
							_0: A2(_synlay$elm_state_button$Machine$newTransition, failure, start),
							_1: {ctor: '[]'}
						}
					}
				}
	...
	var animation = A2(
		_synlay$elm_state_button$Main$update,
		_synlay$elm_state_button$Main$InitAnimation(machine),
		machine);
	return {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Tuple$first(animation),
		_1: _synlay$elm_state_button$Main$change(machine.state.identity)
	};
};
var _synlay$elm_state_button$Main$Animate = function (a) {
	return {ctor: 'Animate', _0: a};
};
var _synlay$elm_state_button$Main$FromJs = function (a) {
	return {ctor: 'FromJs', _0: a};
};
var _synlay$elm_state_button$Main$subscriptions = function (model) {
	var batch = {
		ctor: '::',
		_0: _synlay$elm_state_button$Main$state(_synlay$elm_state_button$Main$FromJs),
		_1: {ctor: '[]'}
	};
	var _p10 = model.state.initAnimation;
	if (_p10.ctor === 'Just') {
			...
			A2(
				...
				batch,
				{
					...
					_0: A2(
						...
						_synlay$elm_state_button$Main$Animate,
						{
							ctor: '::',
							_0: _p10._0.start,
							_1: {ctor: '[]'}
		...
		return _elm_lang$core$Platform_Sub$batch(batch);
	}
};
var _synlay$elm_state_button$Main$main = _elm_lang$html$Html$programWithFlags(
	{init: _synlay$elm_state_button$Main$init, view: _synlay$elm_state_button$Main$view, update: _synlay$elm_state_button$Main$update, subscriptions: _synlay$elm_state_button$Main$subscriptions})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (failure) {
			return A2(
							...
							return A2(
								...
								function (succeed) {
									return _elm_lang$core$Json_Decode$succeed(
										{failure: failure, process: process, start: start, succeed: succeed});
								},
								A2(
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _synlay$elm_state_button$Main$main !== 'undefined') {
    _synlay$elm_state_button$Main$main(Elm['Main'], 'Main', undefined);
}
